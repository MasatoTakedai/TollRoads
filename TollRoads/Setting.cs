...
namespace TollRoads
{
    ...
    [SettingsUIMouseAction(nameof(TollRoads) + "Apply", "CustomUsage")]
    [SettingsUIMouseAction(nameof(TollRoads) + "Cancel", "CustomUsage")]
    public class Setting : ModSetting
    {
        ...
        [SettingsUIMouseBinding(nameof(TollRoads) + "Apply"), SettingsUIHidden]
        public ProxyBinding ApplyMimic { get; set; }

        [SettingsUIMouseBinding(nameof(TollRoads) + "Cancel"), SettingsUIHidden]
    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            ...
            {
                { m_Setting.GetSettingsLocaleID(), "TollRoads" },
